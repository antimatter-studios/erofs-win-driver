...
//! atop a real EROFS image.
//!
//! Strategy: we build a small EROFS image with `fs_erofs::mkfs::build_image`,
...
use erofs_win_driver::mount::{DismountPolicy, Mount};

/// Build a small EROFS image with:
